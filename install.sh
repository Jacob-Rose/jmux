...
echo "  $COMMAND_NAME <directory>  # Start IDE in specific directory"
echo "  $COMMAND_NAME list         # List all active jmux sessions"
echo "  $COMMAND_NAME kill <id>    # Kill specific session"
echo "  $COMMAND_NAME kill-all     # Kill all jmux sessions"
echo "  $COMMAND_NAME attach <id>  # Attach to specific session"
echo ""
echo "To uninstall:"
